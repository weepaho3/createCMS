...
Block rendering stays on `@createcms/core/react`. The headless editor primitive is documented separately: [Editor](/docs/reference/react-editor), [Editor canvas](/docs/reference/react-editor-canvas), and [Editor cms adapter](/docs/reference/react-editor-cms).
