...
- **Merges**: `createMergeRequest`, `getDiff`, `checkConflicts`, `applyConflictResolutions`, `createMergeBlockVersion`, `executeMerge`, `listMergeRequests`, `updateMergeRequest`, `closeMergeRequest`, `reopenMergeRequest`.
