...
<Callout type="info">
  See [Merges](/docs/concepts/merges) for combining branches, and the [Branches API](/docs/reference/branches) for `createBranch`, `listBranches`, `renameBranch`, and `deleteBranch`.
</Callout>
