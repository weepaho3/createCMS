...
<Callout type="info">
  For the retention options, see [Configuration](/docs/reference/configuration); for the pass itself, see `admin.runPruning` in the [Server API](/docs/reference/server-api).
</Callout>
