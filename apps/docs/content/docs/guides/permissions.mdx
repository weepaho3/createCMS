...
| `mergeRequest` | Merge requests: `createMergeRequest`, `executeMerge`, `resolveConflicts`, `getDiff`, close/reopen. |
| `approval` | Sign-off: `requestApproval`, `approve`, `reject`, `cancelApproval`, `listApprovals`. |
