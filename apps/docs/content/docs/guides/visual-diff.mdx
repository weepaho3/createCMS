...
<Callout type="info">
  The diff feeds the review step of [Draft, review, and publish](/docs/guides/content-workflow); [Build your own editor](/docs/guides/building-an-editor) shows where it sits in a full editor UI. For the exact request and response shape, see [`getDiff` in the Merges API](/docs/reference/merges#getdiff).
</Callout>
