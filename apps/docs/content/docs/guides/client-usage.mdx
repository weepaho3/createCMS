...
The React client exposes a media upload hook (see [Upload and serve media](/docs/guides/media-uploads)); combine it with the [media optimize plugin](/docs/plugins/media-optimize) to resize and convert images before upload.
