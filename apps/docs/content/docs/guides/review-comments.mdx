...
<Callout type="info">
  Comments sit inside the [content workflow](/docs/guides/content-workflow): open a merge request, discuss, approve, merge. For every comment method, see the [Server API](/docs/reference/server-api).
</Callout>
