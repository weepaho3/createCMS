...
- [#126](https://github.com/weepaho3/createCMS/pull/126) [`bdfca9b`](https://github.com/weepaho3/createCMS/commit/bdfca9b556cc2ffbd5bfdab0c0a704a4b9ddf677) Thanks [@weepaho3](https://github.com/weepaho3)! - When `updateBlocks` rejects a link property whose value carries the
...
- [#125](https://github.com/weepaho3/createCMS/pull/125) [`ed1eabc`](https://github.com/weepaho3/createCMS/commit/ed1eabc7ac844cad7865a71b8c5a65c0127777e3) Thanks [@weepaho3](https://github.com/weepaho3)! - `ROOT_NOT_FOUND` now says what actually happened: a root that is missing,
...
- [#121](https://github.com/weepaho3/createCMS/pull/121) [`950c526`](https://github.com/weepaho3/createCMS/commit/950c526d301204b9b29324b899eb1efd6ec7c6ea) Thanks [@weepaho3](https://github.com/weepaho3)! - `CMS_ERRORS` ships as its own export so Next.js does not stub it from a `'use client'` chunk. `CMSError` also survives a missing map entry (500 with `cmsCode` preserved) instead of throwing TypeError on `def.status`.
