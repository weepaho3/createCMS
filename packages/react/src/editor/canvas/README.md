...
| `provider.browser.test.tsx`    | Chromium: sidebar palette drag into the canvas under a Provider; outline-style DragHandle moves without add; two canvases under one provider resolve drops on the hovered editable surface.                                                                                                                                       |
